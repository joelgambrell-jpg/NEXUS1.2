window.FORMS = {
  ...
  meg: {
    ...
    buttons: [
      {
        text: "LINE – Megger Reporting (Fillable A.C. Wire Test Sheet)",
        href: "submit.html?form=meg&side=line"
      },
      {
        text: "LOAD – Megger Reporting (Fillable A.C. Wire Test Sheet)",
        href: "submit.html?form=meg&side=load"
      }
    ]
  },
